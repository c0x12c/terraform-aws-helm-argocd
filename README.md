...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_route53"></a> [route53](#module\_route53) | c0x12c/route53/aws | ~> 0.1.14 |
...
| [kubernetes_secret.external_github_oauth](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/secret) | resource |
...
| <a name="input_external_github_oauth_creds"></a> [external\_github\_oauth\_creds](#input\_external\_github\_oauth\_creds) | Map of external GitHub OAuth credentials where key is the GitHub external org | <pre>map(object({<br/>    client_id     = string<br/>    client_secret = string<br/>  }))</pre> | `{}` | no |
...
| <a name="input_slack_webhook_url"></a> [slack\_webhook\_url](#input\_slack\_webhook\_url) | Slack incoming webhook URL for ArgoCD notifications. Takes priority over slack\_token when provided. | `string` | `""` | no |
